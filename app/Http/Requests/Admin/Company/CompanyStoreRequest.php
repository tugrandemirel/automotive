...
class CompanyStoreRequest extends FormRequest
{
    ...
    public function rules(): array
    {
        return [
            ...
            'current_can_pay' => ['nullable', new Enum(CompanyCurrentCanPayEnum::class)],
            'credit_can_pay' => ['nullable', new Enum(CompanyCreditCanPayEnum::class)],
            'general_discount' => 'nullable|numeric',
            'advance_discount' => 'nullable|numeric',
            'one_shot_discount' => 'nullable|numeric',
    ...
    public function attributes()
    {
        return [
            'phone' => 'Telefon Alanı',
            'authorized_person.phone' => 'Yetkili Telefon Alanı'
        ];
    }
}
