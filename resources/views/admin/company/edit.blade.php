...
@section('content')
    ...
    <div class="row">
        <div class="col-12">
            <div class="page-title-box d-sm-flex align-items-center justify-content-between">
                <h4 class="mb-sm-0">Firma Düzenle</h4>
    ...
    <form id="" autocomplete="off" action="{{ route('admin.company.update', ['company' => $company->hashid()]) }}" method="post" enctype="multipart/form-data">
        @csrf
        @method('PUT')
        <div class="row">
            <div class="col-lg-8">
                                    ...
                                    <div class="col-lg-6">
                                        <div class="mb-3">
                                            ...
                                            <input type="text" class="form-control @error('tax_administration') is-invalid @enderror"
                                                   value="{{ $company?->tax_administration ?? '-' }}"
                                ...
                                <div class="row">
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="general_discount" type="number"
                                                   step="any" min="0" id="" class="form-control"
                                                   value="{{ $company?->general_discount ?? '-' }}"
                                                   @error('general_discount') is-invalid @enderror"/>
                                        </div>
                                    </div>
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            <label class="form-label" for="stocks-input">Peşin İskonto:</label>
                                            <input name="advance_discount" type="number"
                                                   value="{{ $company?->advance_discount ?? '-' }}"
                                                   step="any" min="0" id=""
                                    ...
                                    <div class="col-lg-4 col-sm-6">
                                        <div class="mb-3">
                                            ...
                                            <input name="one_shot_discount" type="number"
                                                   value="{{ $company?->one_shot_discount ?? '-' }}"
                                                   step="any" min="0" id=""
                ...
                <div class="row authorizedPeople">
                    @if($company?->authorizedPeople->count() <= 0)
                    ...
                    @else
                        @foreach($company?->authorizedPeople as $authorizedPerson)
                        <div class="col-xl-12 authorizedPerson" id="card-none2">
                            <div class="card">
                                <div class="card-header">
                                    <div class="d-flex align-items-center">
                                        <div class="flex-grow-1">
                                            <h6 class="card-title mb-0">Yetkili Düzenle</h6>
                                        </div>
                                        <div class="flex-shrink-0">
                                            <ul class="list-inline card-toolbar-menu d-flex align-items-center mb-0">
                                                @if($loop->first)
